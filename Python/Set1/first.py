...
if (choice[0] == "c" or choice[0] == "C"):
    try:
     ...
     print(f"{Celcius} degree Celius is Equal to {Celcius_to_Fehranite(Celcius):.2f} degree Fehranite")
   ...
   try: 
    ...
    print(f"{Fehranite} degree Fehranite is Equal to {Fehranite_to_Celcius(Fehranite):.2} degree Celcius")
else:
